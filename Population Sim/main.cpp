...
int main() {
    ...
    for (int i = 0; i < 1; i++) {
        ...
        string fileName = "/Users/rj/Desktop/CASE" + to_string(i+3) + ".csv";
        futs.push_back(tp.submit(bind(&simRunner, i, alpha, beta, birthrate, constant_of_influence, immigration_rate, dim, moving, fileName, 50)));
    }
    myfile.close();
